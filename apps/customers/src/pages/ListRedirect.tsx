...
/**
 * The customers list used to be a page of its own at `/list`, before the entry
 * page at `/` became a tabbed table. Only the redirect is kept, because the path
 * is still reachable: `useAppLinking` builds `/<appSlug>/list` whenever an app
