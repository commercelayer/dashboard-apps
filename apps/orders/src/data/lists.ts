...
export const presets: Record<ListType, FormFullValues> = {
  awaitingApproval: {
    ...
    archived: 'hide',
    viewTitle: t('apps.orders.task.awaiting_approval')
  },
  editing: {
    status_in: ['editing'],
    payment_status_in: [],
    archived: 'hide',
    viewTitle: t('apps.orders.task.editing')
  },
  paymentToCapture: {
    status_in: ['approved'],
    payment_status_in: ['authorized'],
    archived: 'hide',
    viewTitle: t('apps.orders.task.payment_to_capture')
  },
  fulfillmentInProgress: {
    status_in: ['approved'],
    fulfillment_status_in: ['in_progress'],
    archived: 'hide',
    viewTitle: t('apps.orders.task.fulfillment_in_progress')
  },
  history: {
    archived: 'hide',
    viewTitle: t('apps.orders.task.history')
  },
  pending: {
    status_in: ['pending'],
    archived: 'show',
    viewTitle: t('apps.orders.task.carts')
  },
  archived: {
    archived: 'only',
    viewTitle: t('apps.orders.task.archived')
  }
}
