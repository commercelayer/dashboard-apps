...
export function useSummaryRows(order: Order): {
  ...
  const { isEditing, diffTotalAndPlacedTotal, amountToCollect } =
        ...
        {amountToCollect != null && (
          <Spacer bottom="8">
            <Alert status="warning">
              {amountToCollect} still to be collected.
              <br />
              Share the checkout link so the customer can pay the difference, or
              adjust the total.
            </Alert>
          </Spacer>
        )}
