...
/**
 * The payments an action acts on, one line each.
 *
 * Shared by the confirm step and the result step on purpose: they describe the
 * same thing, and when each built its own line the two drifted apart, the
 * result flattening several payments into a single row of instruments.
 */
...
interface Props {
  ...
  /** Amount and instrument, e.g. "$64.00 · Mastercard ··4242", or a
   * `PaymentBreakdown` when the action touches several payments. */
    ...
    <>
      ...
      <Modal.Body>
        <div className="flex flex-col items-center text-center">
          ...
          {/* Same gap the result step puts under its own title, so a confirm
              and the result it leads to are spaced alike. */}
          <Spacer top="1">
